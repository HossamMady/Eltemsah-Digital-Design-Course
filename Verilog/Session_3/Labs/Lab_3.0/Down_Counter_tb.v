...
initial
 begin
  ...
  latch_tb = 1'b0; 
  #30                         // 30 ns delay so the counter decreament 3 times so counter_tb should go from 10 to 7
  ...
  latch_tb = 1'b0; 
  #80                         // 80 ns delay so the counter decreament 8 times so counter_tb should go from 7 to 0 (to test the flag)
